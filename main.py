...
with tab_post:
    ...
    fig.add_trace(go.Scatter(x=df_main.index[-90:], y=c_series.iloc[-90:], name="法人成本線", line=dict(dash='dot')))
...
st.caption(f"系統規格：{SYSTEM_CONFIG['VERSION']} | 以法人成本線 (VWAP) 為核心判定標準")
